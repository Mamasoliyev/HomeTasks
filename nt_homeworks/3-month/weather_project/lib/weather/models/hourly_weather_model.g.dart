...
HourlyWeatherModel _$HourlyWeatherModelFromJson(
  Map<String, dynamic> json,
) => HourlyWeatherModel(
  location: HourlyLocation.fromJson(json['location'] as Map<String, dynamic>),
  current: HourlyCurrent.fromJson(json['current'] as Map<String, dynamic>),
  forecast: HourlyForecast.fromJson(json['forecast'] as Map<String, dynamic>),
);
...
HourlyCurrent _$HourlyCurrentFromJson(Map<String, dynamic> json) =>
    HourlyCurrent(
      ...
      condition: HourlyCondition.fromJson(
...
Map<String, dynamic> _$HourlyCurrentToJson(HourlyCurrent instance) =>
    <String, dynamic>{
    ...
    HourlyForecast(
      forecastday:
          (json['forecastday'] as List<dynamic>)
              .map((e) => HourlyForecastday.fromJson(e as Map<String, dynamic>))
              .toList(),
    );
...
HourlyForecastday _$HourlyForecastdayFromJson(Map<String, dynamic> json) =>
    HourlyForecastday(
      date: DateTime.parse(json['date'] as String),
      dateEpoch: (json['date_epoch'] as num).toInt(),
      day: HourlyDay.fromJson(json['day'] as Map<String, dynamic>),
      astro: Astro.fromJson(json['astro'] as Map<String, dynamic>),
      hour:
          (json['hour'] as List<dynamic>)
              .map((e) => HourlyCurrent.fromJson(e as Map<String, dynamic>))
              .toList(),
    );

Map<String, dynamic> _$HourlyForecastdayToJson(HourlyForecastday instance) =>
    <String, dynamic>{
...
HourlyDay _$HourlyDayFromJson(Map<String, dynamic> json) => HourlyDay(
  maxtempC: (json['maxtemp_c'] as num).toInt(),
...
Map<String, dynamic> _$HourlyDayToJson(HourlyDay instance) => <String, dynamic>{
...
HourlyLocation _$HourlyLocationFromJson(Map<String, dynamic> json) =>
    HourlyLocation(
...
Map<String, dynamic> _$HourlyLocationToJson(HourlyLocation instance) =>
    <String, dynamic>{
      'name': instance.name,
